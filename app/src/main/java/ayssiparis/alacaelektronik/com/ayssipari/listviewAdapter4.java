...
public class listviewAdapter4 extends BaseAdapter
{
    ...
    public listviewAdapter4(Activity activity, ArrayList<HashMap> list, int list_row) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtThird.setTextColor(Main.resources.getColor(R.color.material_blue_grey_800));
        holder.txtFourth.setTextColor(Main.resources.getColor(R.color.material_blue_grey_800));
